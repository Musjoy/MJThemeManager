...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/MJThemeManager'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Raymond' => 'Ray.musjoy@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/MJThemeManager.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'MJThemeManager' => ['MJThemeManager/Assets/*.png']
  # }
